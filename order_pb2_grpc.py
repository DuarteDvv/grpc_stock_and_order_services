...
class OrderServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.End = channel.unary_unary(
                '/order.OrderService/End',
                request_serializer=order__pb2.Empty.SerializeToString,
                response_deserializer=order__pb2.EndResponse.FromString,
                _registered_method=True)
...
def add_OrderServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'End': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=order__pb2.EndResponse.SerializeToString,
            ),
    }
...
class OrderService(object):
    ...
    def End(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            order__pb2.EndResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
